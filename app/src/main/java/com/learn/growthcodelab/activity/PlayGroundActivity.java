...
import com.learn.growthcodelab.playground.TextInputLayoutFragment;
...
public class PlayGroundActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportFragmentManager()
                .beginTransaction()
                .add(R.id.fl_play_ground_container, TextInputLayoutFragment.newInstance(), "text_input_layout")
                .addToBackStack(null)
                .commit();
    }
}
